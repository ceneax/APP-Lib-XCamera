package ceneax.lib.xcamera.util;
...
public class ImageUtil {
     ...
     */
    public static Matrix getCorrectionMatrix(Matrix matrix, ImageProxy imageProxy, PreviewView previewView) {
        matrix.reset();
